		...
		<%
			...
			try {
				if (request.getParameter("add") != null) {
					stringNumber1 = calc.add(request.getParameter("number1"), request.getParameter("number2"));
					focus = "number2";
				}
				if (request.getParameter("subtract") != null) {
					stringNumber1 = calc.subtract(request.getParameter("number1"), request.getParameter("number2"));
					focus = "number2";
				}
				if (request.getParameter("multiply") != null) {
					stringNumber1 = calc.multiply(request.getParameter("number1"), request.getParameter("number2"));
					focus = "number2";
				}
				if (request.getParameter("divide") != null) {
					stringNumber1 = calc.divide(request.getParameter("number1"), request.getParameter("number2"));
					focus = "number2";
				}
			}
