...
public class V10_X2025989Servlet extends HttpServlet {
...
//			checkList = checkList.split("\\[")[1];
//			checkList = checkList.split("\\]")[0];
...
//						checkList[i] == true
						foundBrand == true
//						Arrays.asList(checkArray).contains(car.getMerk())
